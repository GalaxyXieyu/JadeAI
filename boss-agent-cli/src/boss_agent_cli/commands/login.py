...
@click.option("--skip-cookie", is_flag=True, default=False, help="跳过本地浏览器 Cookie 提取（避免 macOS 钥匙串弹窗）")
@click.pass_context
def login_cmd(ctx: click.Context, timeout: int, cookie_source: str | None, cdp: bool, skip_cookie: bool) -> None:
